...
class PIDExtractionPipeline:
    ...
    def extract(self, pdf_path: Path) -> ExtractionResult:
        ...
        result.raw_pages.extend(self._extract_embedded_text(pdf_path))

        ocr_pages, ocr_tags, warnings = self._extract_ocr(pdf_path)
    ...
    def _extract_ocr(self, pdf_path: Path) -> tuple[list[PageText], list[TagRecord], list[str]]:
        pages: list[PageText] = []
        tags: list[TagRecord] = []
        warnings: list[str] = []
